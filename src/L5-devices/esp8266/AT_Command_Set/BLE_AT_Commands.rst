...
-  [ESP32 Only] :ref:`AT+BLESECPARAM <cmd-BLESMPPAR>`: Query/Set Bluetooth LE m_encryption parameters.
-  [ESP32 Only] :ref:`AT+BLEENC <cmd-BLEENC>`: Initiate Bluetooth LE m_encryption request.
...
-  [ESP32 Only] :ref:`AT+BLEENCDEV <cmd-BLEENCDEV>`: Query bonded Bluetooth LE m_encryption device list.
-  [ESP32 Only] :ref:`AT+BLEENCCLEAR <cmd-BLEENCCLEAR>`: Clear Bluetooth LE m_encryption device list.
...
-  The bit pattern for parameters ``<init_key>`` and ``<rsp_key>`` is:
   ...
   -  Bit0: Used to exchange the m_encryption key in the init key & response key.
...
-  **<enc_result>**:
   ...
   - 0: m_encryption succeeded
   - 1: m_encryption failed
...
Query bonded Bluetooth LE m_encryption device list.
