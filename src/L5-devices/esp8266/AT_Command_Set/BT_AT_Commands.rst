...
-  [ESP32 Only] :ref:`AT+BTENCDEV <cmd-BTENCDEV>`: Query Classic Bluetooth m_encryption device list.
-  [ESP32 Only] :ref:`AT+BTENCCLEAR <cmd-BTENCCLEAR>`: Clear Classic Bluetooth m_encryption device list.
